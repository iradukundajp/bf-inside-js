...
/**
 * check if the text is long or short
 *
 * @parameter {string} [text = ''] - the string to check
 * @parameter {number } [cutoff = 0] - the number of characters
 * @return  {string } _ short or long
 */
